...
import music2.management.json.converters.composite.{CombinerConverter, KeyboardConverter, KeyboardScaleConverter, RiffConverter}
...
object JsonParser {
  ...
  val converters =
    Seq(
      ...
      KeyboardScaleConverter, KeyboardConverter)
